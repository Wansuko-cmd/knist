...
object JTimes {
    external fun timesD0ToD1(x: Float, y: Long, result: Long, runtime: Long)

    external fun timesD1ToD0(x: Long, y: Float, result: Long, runtime: Long)
    external fun timesD1ToD1(x: Long, y: Long, result: Long, runtime: Long)
    external fun timesD1ToD2(x: Long, y: Long, yi: Int, yj: Int, axis: Int, result: Long, runtime: Long)
